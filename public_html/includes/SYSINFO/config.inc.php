...
$settings['hide']['filesystems'] = array(
	'tmpfs', 'ecryptfs', 'nfsd', 'rpc_pipefs', 'pstore', 'efivarfs', 'configfs', 'debugfs', 'fuse.gvfsd-fuse',
	'usbfs', 'devpts', 'fusectl', 'securityfs', 'fuse.truecrypt', 'cgroup', 'devtmpfs', 'mqueue', 'hugetlbfs', 'proc', 'autofs', 'sysfs', );
